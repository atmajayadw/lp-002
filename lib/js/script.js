...
function showSlides(n) {
    ...
    slides[slideIndex - 1].classList.add('wow', 'animate__animated', 'animate__fadeIn');
}
...
// Feature
const animate8 = document.querySelector('#features .feature.one');
animate8.classList.add('wow', 'animate__animated', 'animate__fadeInLeft', 'animate__delay-1s');

const animate9 = document.querySelector('#features .feature.two');
animate9.classList.add('wow', 'animate__animated', 'animate__fadeInUp', 'animate__delay-2s');

const animate10 = document.querySelector('#features .feature.three');
animate10.classList.add('wow', 'animate__animated', 'animate__fadeInRight', 'animate__delay-3s');